...
karachi_blood_banks = [
    ...
    {"Name": "Northern Blood Bank", "City": "Karachi", "Location": "North Nazimabad", "Timings": "24/7", "Contact": "+92-323-1234567", "Available Blood Groups": "AB-, A-, O+, O-", "Website": "https://northernbloodbank.com"},
...
st.markdown("""
 ...
 <style>
    ...
    .loading-overlay {
        ...
        width: 100vw;
        height: 100vh;
        background: linear-gradient(to bottom right, #007bff, #00bcd4);
        display: flex;
    ...
    .stApp {
        filter: blur(10px);
        animation: unBlur 2s ease-in-out forwards;
        animation-delay: 2s;
    }
